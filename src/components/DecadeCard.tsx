...
const DecadeCard = ({ decade, index, onSelect }: DecadeCardProps) => {
  ...
  return (
    <div className="relative flex items-center gap-6 md:gap-10 group">
      {/* Timeline dot */}
      <div className="absolute right-1/2 translate-x-1/2 md:right-auto md:left-1/2 md:-translate-x-1/2 z-10">
        <div className="w-14 h-14 rounded-full bg-accent border-4 border-primary flex items-center justify-center text-2xl shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform duration-300">
          {decade.icon}
        </div>
      </div>
